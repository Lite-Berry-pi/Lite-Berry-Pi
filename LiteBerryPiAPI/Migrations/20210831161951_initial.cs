...
namespace Lite_Berry_Pi.Migrations
{
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Design",
                columns: new[] { "Id", "ActivityLogId", "DesignCoords", "TimeStamp", "Title" },
                values: new object[,]
                {
                    { 1, null, "000011111", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Test1" },
                    { 2, null, "10011001", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Test2" },
                    { 3, null, "100010101", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Test3" }
                });
